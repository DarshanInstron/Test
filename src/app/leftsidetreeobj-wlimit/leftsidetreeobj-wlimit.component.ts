...
@Component({
  selector: 'app-leftsidetreeobj-wlimit',
  templateUrl: './leftsidetreeobj-wlimit.component.html',
  styleUrls: ['./leftsidetreeobj-wlimit.component.scss']
})
export class LeftsidetreeobjWlimitComponent {
  @Input() LevelTypeInputs = 'a';
  @Input() LevelUpToInputs = '99';
  @Input() WithParameters = '0';
  @Output() PassobjMultiLvlTreeviewInfo = new EventEmitter<any>();
  ...
  constructor(public _KpiPageService: KpiPageService,  private _GlobalConstantsService: GlobalConstantsService, public _ValidationerrormessagesService: ValidationerrormessagesService) { }
    ...
    if (this.objMultiLvlTreeviewInfoList.length > 0) {
      for (var i = 0; i < this.objMultiLvlTreeviewInfoList.length; i++) {
        ...
        if (objMultiLvlTreeviewInfo.objMultiLvlTreeviewInfoList.length > 0) {
            ...
            if (objMultiLvlTreeviewInfoTemp1.objMultiLvlTreeviewInfoList.length > 0) {
              for (var k = 0; k < objMultiLvlTreeviewInfoTemp1.objMultiLvlTreeviewInfoList.length; k++) {
                ...
                if (objMultiLvlTreeviewInfoTemp2.objMultiLvlTreeviewInfoList.length > 0) {
                    ...
                    if (objMultiLvlTreeviewInfoTemp3.objMultiLvlTreeviewInfoList.length > 0) {
                      for (var m = 0; m < objMultiLvlTreeviewInfoTemp3.objMultiLvlTreeviewInfoList.length; m++) {
                        ...
                        if (objMultiLvlTreeviewInfoTemp4.objMultiLvlTreeviewInfoList.length > 0) {
                          for (var n = 0; n < objMultiLvlTreeviewInfoTemp4.objMultiLvlTreeviewInfoList.length; n++) {
                            ...
                            if (objMultiLvlTreeviewInfoTemp5.objMultiLvlTreeviewInfoList.length > 0) {
                              for (var o = 0; o < objMultiLvlTreeviewInfoTemp5.objMultiLvlTreeviewInfoList.length; o++) {
                                ...
                                this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfoTemp6);
                                break;
                              }
                              ...
                              this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfoTemp5);
                              break;
                            }
                          }
                          ...
                          this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfoTemp4);
                          break;
                        }
                      }
                      ...
                      this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfoTemp3);
                      break;
                    }
                  }
                  ...
                  this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfoTemp2);
                  break;
                }
              }
              ...
              this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfoTemp1);
              break;
            }
          }
          ...
          this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfo);
          break;
        }
      }
    }
  ...
  //     objMultiLvlTreeviewInfo.isChecked = IsTrueFalse;
  //     this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfo.C001_LevelId);
  ...
  UncheckAllorSelectedParamters(C001_LevelId: any, IsUncheckAll: any, IsTrueFalse: any) {
    ...
    if (IsUncheckAll == "1") {
      this.PassobjMultiLvlTreeviewInfo.emit('');
    }
  }

  public ShowKpiBoxesInfoByObjectClick(objMultiLvlTreeviewInfoTemp: any) {
    this._GlobalConstantsService.CheckSessionIsRuningOrNot();
    ...
    if (this.iSelectedParamCount > 20) {
      ...
      SelectedParamIds = SelectedParamIds.replace(objMultiLvlTreeviewInfoTemp.C001_LevelId, "");
      SelectedParamIds = SelectedParamIds.replace(",,", ",");
      this.iSelectedParamCount--;
      setTimeout(() => {
        this.UncheckAllorSelectedParamters(objMultiLvlTreeviewInfoTemp.C001_LevelId, "0", false);
      }, 1000);
    }
    this.PassobjMultiLvlTreeviewInfo.emit(objMultiLvlTreeviewInfoTemp);
    return;
  }
